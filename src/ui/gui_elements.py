...
class GuiElements:
    ...
    def create_winning_table(self):
        ...
        rect2 = pg.Rect(10, 100, 80, 30)
        text_entry = pygame_gui.elements.UITextEntryLine(relative_rect=rect2, manager=self._manager,
                                                       container=self._winning_table)

        time = self._game_view.give_exact_time()
        rect3 = pg.Rect(10, 100, 200, 60)
        label_text = f"your time: {time}"
        text_box = pygame_gui.elements.UILabel(relative_rect=rect3,
                                               text=label_text,
                                               manager=self._manager,
                                               container=self._winning_table)
